...
namespace Testing
{
	...
	public:
		...
		TEST_METHOD(TestCActorConstructor)
		{
			...
			Assert::AreNotEqual(std::wstring(L"Kumar"), actor.GetName());
		}
		TEST_METHOD(TestCActorEnabledGetterSetter)
		{
			CActor actor(L"Harold");
		...
		TEST_METHOD(TestCActorClickableGetterSetter)
		{
			CActor actor(L"Harold");
			// test default value and getter 
		...
		TEST_METHOD(TestCActorPositionGetterSetter)
		{
			CActor actor(L"Harold");
			// default value test
			...
			actor.SetPosition(Gdiplus::Point(60, 90));
			Assert::AreEqual(60, actor.GetPosition().X);
			Assert::AreEqual(90, actor.GetPosition().Y);
